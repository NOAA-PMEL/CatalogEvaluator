...
<div id="show-rubric" class="content scaffold-show" role="main">
    ...
    <f:display bean="rubric"/>
    <g:form resource="${this.rubric}" method="DELETE">
        <fieldset class="buttons">
            <g:link class="edit" action="edit" resource="${this.rubric}"><g:message code="default.button.edit.label"
                                                                                    default="Edit"/></g:link>
